...
import static org.jboss.demos.server.dmr.ModelDescriptionConstants.OUTCOME;
...
//        Dispatcher dispatcher = new SimpleDispatcher();
        ...
        operation.get("child-type").set("cache");
        operation.get(ModelDescriptionConstants.ADDRESS).add("subsystem").add("ejb3");
